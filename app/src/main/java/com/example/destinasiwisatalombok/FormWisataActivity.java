...
public class FormWisataActivity extends AppCompatActivity {
    ...
    final String[] tipeFavorite = {Wisata.GUNUNG, Wisata.BUKIT, Wisata.TAMAN, Wisata.PANTAI};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_from_wisata);
        inisialisasiView();
    }
    ...
    private void simpan() {
        if (isDataValid()) {
            ...
            Toast.makeText(this,"Data berhasiil disimpan",Toast.LENGTH_SHORT).show();
